...
public class JDBCExample1 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String userName = "kh_jjy"; // 사용자 계정명
			...
			// -> sql 이 SELECT 문일 때 결과로 ResultSet 객체 반환
			// 2) int Statement.executeUpdate(sql);
			// -> sql 이 DML(INSERT/UPDATE/DELETE)일 때 실행 메서드
			...
			// -> 자원반환을 하지 않으면 DB 와 연결된 Connection 이 그대로 남아있어서
